...
from codecplus.codecs.wav_tokenizer.encoder.quantization.core_vq import (
    LanguageVectorQuantization,
)
...
class ResidualVectorQuantizer(nn.Module):
    ...
    def encode(
        ...
        The RVQ encode method sets the appropriate number of quantizers to use and returns indices for each
        quantizer.
        """
        n_q = self.get_num_quantizers_for_bandwidth(frame_rate, bandwidth)
