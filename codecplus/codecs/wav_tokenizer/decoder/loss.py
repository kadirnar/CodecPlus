...
class MelSpecReconstructionLoss(nn.Module):
    """L1 distance between the mel-scaled magnitude spectrograms of the ground truth sample and the generated
    sample.
    """
...
class GeneratorLoss(nn.Module):
    ...
    def forward(
        ...
        for dg in disc_outputs:
            loss_item = torch.mean(torch.clamp(1 - dg, min=0))
...
class FeatureMatchingLoss(nn.Module):
    ...
    Calculates the feature matching loss between feature maps of the sub-discriminators.
    """
...
class DACGANLoss(nn.Module):
    """
    Computes a discriminator loss, given a discriminator on generated waveforms/spectrograms compared to
    ground truth waveforms/spectrograms.
