...
from codecplus.codecs.wav_tokenizer.decoder.discriminator_dac import DACDiscriminator
from codecplus.codecs.wav_tokenizer.decoder.discriminators import (
    MultiPeriodDiscriminator,
    MultiResolutionDiscriminator,
)
from codecplus.codecs.wav_tokenizer.decoder.feature_extractors import FeatureExtractor
from codecplus.codecs.wav_tokenizer.decoder.heads import FourierHead
from codecplus.codecs.wav_tokenizer.decoder.helpers import plot_spectrogram_to_numpy
from codecplus.codecs.wav_tokenizer.decoder.loss import (
    DACGANLoss,
    DiscriminatorLoss,
    FeatureMatchingLoss,
    GeneratorLoss,
...
class WavTokenizer(VocosExp):
    """
    WavTokenizer is a subclass of VocosExp that overrides the parent experiment to function as a conditional
    GAN.
